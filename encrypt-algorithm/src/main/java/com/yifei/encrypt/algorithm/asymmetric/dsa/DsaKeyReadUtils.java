 ...
 * @date 2020/6/3 15:07
 */
public class DsaKeyReadUtils {
    private DsaKeyReadUtils() {
    }
    ...
    public static PublicKey getPublicKeyByPem(String publicKeyFilePath) {
        return KeyReadUtils.getPublicKeyByPem(KeyAlgorithmEnum.DSA.getAlgorithm(), publicKeyFilePath);
    }
    ...
    public static PrivateKey getPrivateKeyByPem(String privateKeyFilePath) {
        return KeyReadUtils.getPrivateKeyByPem(KeyAlgorithmEnum.DSA.getAlgorithm(), privateKeyFilePath);
    }
    ...
    public static PublicKey getPublicKeyByString(String publicKey) {
        return KeyReadUtils.getPublicKeyByString(KeyAlgorithmEnum.DSA.getAlgorithm(), publicKey);
    }
    ...
    public static PrivateKey getPrivateKeyByString(String privateKey) {
        return KeyReadUtils.getPrivateKeyByString(KeyAlgorithmEnum.DSA.getAlgorithm(), privateKey);
    }
}
